<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属科目" prop="suoshukemu">
          <el-input v-model="ruleForm.suoshukemu" 
              placeholder="所属科目" clearable  :readonly="ro.suoshukemu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属科目" prop="suoshukemu">
              <el-input v-model="ruleForm.suoshukemu" 
                placeholder="所属科目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="院系班级" prop="yuanxibanji">
          <el-input v-model="ruleForm.yuanxibanji" 
              placeholder="院系班级" clearable  :readonly="ro.yuanxibanji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="院系班级" prop="yuanxibanji">
              <el-input v-model="ruleForm.yuanxibanji" 
                placeholder="院系班级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.pigairiqi = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zuoyemingcheng = true;
          ...
          if(o=='suoshukemu'){
            this.ruleForm.suoshukemu = obj[o];
	    this.ro.suoshukemu = true;
            continue;
          }
          if(o=='xueshengzuoye'){
	    ...
	    this.ro.xueshengxingming = true;
          ...
          if(o=='yuanxibanji'){
            this.ruleForm.yuanxibanji = obj[o];
	    this.ro.yuanxibanji = true;
            continue;
          }
          if(o=='gonghao'){
	...
	this.ruleForm.pingyu = this.ruleForm.pingyu.replace(reg,'../../../ssm5t4c8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
