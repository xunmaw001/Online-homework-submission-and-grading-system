  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:#000;fontSize:28px;">网络作业提交与批改系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">院系班级</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yuanxibanji" class="input" type="text" placeholder="院系班级">
			   </div>
			 </div> -->
			<el-form-item label="院系班级" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.yuanxibanji" autocomplete="off" placeholder="院系班级"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			...
			<!-- <div v-if="tableName=='laoshi'" class="input-group">
			   <div class="label">所属院系</div>
			   <div class="input-container">
			     <input v-model="ruleForm.suoshuyuanxi" class="input" type="text" placeholder="所属院系">
			   </div>
			 </div> -->
			<el-form-item label="所属院系" class="input" v-if="tableName=='laoshi'">
			  <el-input v-model="ruleForm.suoshuyuanxi" autocomplete="off" placeholder="所属院系"  />
			</el-form-item>
			<!-- <div v-if="tableName=='laoshi'" class="input-group">
			...
			<el-form-item label="联系手机" class="input" v-if="tableName=='laoshi'">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.gonghao) && `laoshi` == this.tableName){
      ...
      if(`laoshi` == this.tableName && this.ruleForm.lianxishouji&&(!this.$validate.isMobile(this.ruleForm.lianxishouji))){
